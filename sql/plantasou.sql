...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 22, 2021 at 07:05 PM
...
(11, 'Abóbora Japonesa', 'Abóbora é um vegetal com poucas calorias e rica em potássio, vitamina C e betacaroteno;', 'Ela benéfica para a visão, coração, pele e imunidade.', 175.2, 4, '69f008040fdd6057f2e988a9b3b0956f.jpeg'),
(12, 'Tomate', 'Com uma alta quantidade de vitaminas A, C, K e cálcio;', 'É rico em licopeno, um antioxidante que ajuda a proteger a pele dos danos causados pela luz do sol. O consumo frequente do alimento ajuda na textura e na saúde da sua pele, já que ajuda a minimizar poros dilatados, curar a acne e erupções cutâneas ou tratar pequenas queimaduras. Devido à presença de vitamina K e cálcio, o tomate ajuda a fortalecer e reparar os ossos.', 264, 5, 'c8f81d13e4081dfa2eb366d7a41c35ce.jpeg'),
(13, 'Alho-poró', 'É rica em fibras, carotenóides, vitamina E, A, C e minerais como selênio, cálcio, zinco, cobre e manganês, além de ter poucas calorias;', 'Ela ajuda na visão, na digestão e no fortalecimento dos ossos.', 121, 6, '102b3273f1c6c867309fe6bb2b198c65.jpeg'),
(14, 'Mexerica', 'É pobre em gorduras e fonte de vitaminas C, A e B6. Além disso, contém tiamina, folato, potássio, cálcio, ferro e magnésio.', 'Previne envelhecimento precoce, reduz inflamações, alivia a prisão de ventre, aumenta a imunidade, afasta doenças hepáticas e previne anemia.', 80, 7, '2ace5144c5d6b6898603e4e8a6b69069.jpeg');
